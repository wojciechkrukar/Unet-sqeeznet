...
def SqueezeUNet(inputs, num_classes=None, include_top=False, dropout=0.0, fireplus=False, reshape_out=False, activation='sigmoid'):
   ...
   # model.compile(optimizer = Adam(lr=1e-4),  loss = 'binary_crossentropy', metrics = ['accuracy'])
    #model.compile(optimizer = Adam(lr=1e-05), loss = "binary_crossentropy", metrics=["accuracy"])
    return model
